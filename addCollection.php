...
$snippet_fields = array( "asset" => array('key' => 'snippets/cartCollection.liquid', 'value' => $snippet_code));
...
if (strpos($themeFile['value'], "{%include 'cartCollection' %}") === false || strpos($themeFile['value'], "<!-- hnk portfolio proof -->") === false) {
$newHtml = $themeFile['value'];
if (strpos($themeFile['value'], "{%include 'cartCollection' %}") === false) {
$replacedCode = "{%include 'cartCollection' %}</head>";
